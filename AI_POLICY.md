...
`golangci-lint run ./...`, and the race-detector test suite `go test -race ./...`), plus the
fuzz-smoke and e2e jobs in CI. AI assistance does not lower the bar.

## How this project itself uses AI

In the interest of transparency: go-mqtt is partly developed with AI assistance
